...
DROP TABLE IF EXISTS `chinese_food`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
LOCK TABLES `chinese_food` WRITE;
/*!40000 ALTER TABLE `chinese_food` DISABLE KEYS */;
INSERT INTO `chinese_food` VALUES (1,'Mie Wonton Kuah','Mie dengan pangsit rebus yang memiliki isi daging cincang.'),(2,'Ayam Hainan','Ayam kampung rebus yang digoreng dengan sedikit minyak dan bumbu bawang putih dan jahe.'),(3,'Capcay Kuah','Tumis 10 jenis sayuran dengan seafood atau daging.'),(4,'Mie Goreng','Mie goreng dengan udang, telur, kol dan wortel.'),(5,'Ayam Kung Pao','Ayam goreng khas Sichuan dengan kacang mede.'),(6,'Fuyunghai','Telur dadar dengan daging kepiting.'),(7,'Udang Mayonnaise','Udang yang digoreng dalam balutan tepung gurih dan renyah, kemudian dicampur dengan saus mayonnaise yang segar.'),(8,'Sapi Lada Hitam','Sapi lada hitam mempunyai cita rasa yang cukup tajam sedikit pedas.'),(9,'Siomay Dimsum','Siomay dengan daging sapi, rumput laut, dan keju.'),(10,'Cah Kailan','Tumis sayur Kailan yang direbus dan disajikan dengan bumbu saus tiram.'),(11,'Sapo Tahu Ayam atau Seafood','Masakan sehat perpaduan dari beberapa macam sayur, daging ayam atau Seafood dan tahu.'),(12,'Kwetiau Goreng','Kwetiau goreng dengan tambahan udang, telur dan fillet dada ayam.'),(13,'Tahu Cabai Garam','Tahu goreng krispy dengan merica, kaldu, dan irisan tipis cabai dan bawang putih.'),(14,'Udang Asam Manis','Udang goreng dengan citarasa yang manis, gurih dan sedikit asam saos tomat.'),(15,'Lamien Ayam Panggang','Mie Lamien dengan cita rasa khas Asia, dipadukan bersama ayam yang dipanggang yang telah diberi bumbu angkak.'),(16,'Kepiting Lada Hitam','Kepiting rebus dengan lada hitam, ebi sangrai, kecap manis, dan saus tiram.'),(17,'Ayam Saus Lemon','Daging dada ayam fillet yang dimasak dengan jeruk, minyak wijen, telur dan merica.'),(18,'Nasi Goreng Sapi/Ikan Asin/Seafood','Nasi goreng yang praktis dengan daging ayam, sapi, kambing, seafood, ikan asin, dan pete.'),(19,'Lumpia Goreng','Spring roll dimsum dengan isi rebung dan ayam.'),(20,'Ayam Bakar Kecap','Ayam bakar dengan olesan mentega dan jeruk nipis peras.'),(21,'Kwetiau Seafood Szechuan','Kwetiau saus Szechuan yang dipadukan dengan seafood, ayam dan sayur.'),(22,'Bihun Bebek','Bihun goreng dengan saus hoisin, kucai, minyak wijen serta minyak biji anggur.'),(23,'Sambal Petis Kecap','Gorengan dengan kecap dan saus dari udang rebon yang dikeringkan.'),(24,'Cah Kailan Saus Tiram','Sayuran hijau yang ditumis (cah) dengan tambahan saus tiram.'),(25,'Lontong Cap Go Meh','Lontong yang dibanjur dengan kuah opor ayam, sayur lodeh, sambal goreng hati, acar , telur pindang, abon sapi, bubuk koya, sambal dan kerupuk. '),(26,'Tumis Putren','Tumis jagung muda dengan tambahan tempe dan cabai iris.'),(27,'Kwetiau Sapi','Kwetiau yang dicampur dengan daging sapi dan sayur.'),(28,'Nasi Capcay','Nasi putih dengan sayuran, potongan ayam/udang/bakso, yang ditumis bersama minyak wijen dan diguyur campuran tepung maizena dan sedikit air.');
/*!40000 ALTER TABLE `chinese_food` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `coffee` VALUES (1,'5','Kopi Tubruk','Kopi tubruk khas Jawa dan Bali.'),(2,'5','Kopi Kawa Padang','Minuman kopi khas Indonesia yang berasal dari Sumatera Barat yang tidak menggunakan biji kopi melainkan tidak menggunakan biji melainkan daun dari tanaman kopi.'),(3,'5','Kopi Talua Bukittinggi','Kopi yang berasal dari tanah Minang dengan campuran Kuning telur yang dikocok sampai berbusa sambil diberi susu kental manis dan bubuk kayu manis. '),(4,'5','Kopi Lelet Rembang','Tradisi kopi khas Indonesia yang berasal dari Rembang. Biji kopi digiling dengan ukuran giling ultra fine sehingga menghasilkan rasanya sangat pahit dan meninggalkan aftertaste yang lama. '),(5,'5','Kopi Joss Yogyakarta','Kopi yang ditambahkan arang panas sehingga mendidih saat disajikan.'),(6,'5','Kopi Durian','Tradisi kopi yang berasal dari Lampung, Bengkulu dan Medan. Durian dicocol ke dalam kopi tubruk panas sebelum dimakan.'),(7,'5','Kopi Rarobang Ambon','Kopi dari Ambon yang disajikan dengan taburan biji kenari di atasnya sebagai pelengkap. '),(8,'5','Kopi Saring Aceh','Kopi yang berasal dari Gayo dan Ulee Kareeng. Kopi disajikan dengan metode metode seduh yang menggunakan saringan atau filter.'),(9,'5','Kopi Ijo Tulungagung','Kopi yang berasal dari Tulungagung, berwarna hijau dan memiliki manfaat utama sebagai penurun berat badan. '),(10,'5','Kopi Takar Mandailing Natal','Kopi khas Indonesia yang berasal dari Sipirok, Kabupaten Mandailing Natal, Sumatera Utara. Kopi ini disajikan  disajikan dengan dalam batok kelapa yang dikeraskan, selain itu kopi ini diaduk dengan menggunakan kayu manis.');
...
--
-- Dumping data for table `fresh_milk`
--

LOCK TABLES `fresh_milk` WRITE;
/*!40000 ALTER TABLE `fresh_milk` DISABLE KEYS */;
INSERT INTO `fresh_milk` VALUES (1,4,'Fresh Milk & Oatmeal Raisin','Plain fresh milk with nice (soft, chewy, crunchy) oatmeal raisin cookie which tastes similar to a granola bar'),(2,4,'Fresh Milk & Chocolate','Plain fresh milk with the creamy peanut butter that’s swirled into a chocolate cookie .'),(3,4,'Fresh Milk & Oatmeal Chocolate Chip','Plain fresh milk with chocolate chips cookie that has a perfect sweetness.'),(4,4,'Fresh Milk & White Chocolate Macadamia','Plain fresh milk with luscious white chocolate and big chunks of macadamia nuts make for great texture.'),(7,4,'Fresh Milk & Chocolate Pecan Caramel','Plain fresh milk with chocolate, pecans, and so much caramel that can get a little sticky.'),(8,4,'Fresh Milk & Rocky Road','Plain fresh milk with nutty and chocolate and a gooey marshmallow in the center.'),(9,4,'Fresh Milk & Chocolate Chip Walnut','Plain fresh milk with Walnut Chip. The walnut chunks give this an earthiness, and overall, the sweetness is appropriately mellow.'),(10,4,'Fresh Milk & Cinnamon Sugar','Plain fresh milk with the sweet cinnamon sugar cookie.'),(11,4,'Fresh Milk & Banana Split','Plain fresh milk with banana-flavored baked cookies.'),(12,4,'Fresh Milk & GF Chip','Plain fresh milk with gluten-free cookie.'),(13,4,'Fresh Milk  & Birthday Cookie','Plain fresh milk with cookies covered in colorful seasonal dots made from sugar.'),(14,4,'Fresh Milk & Cheese Chip','Plain fresh milk with salty cheese cookie.'),(15,4,'Fresh Milk & GF Peppermint Bark','Plain fresh milk with gluten-free peppermint bark.'),(16,4,'Fresh Milk & White Chocolate','Plain fresh milk with White Chocolate Raspberry.');
/*!40000 ALTER TABLE `fresh_milk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `indonesian_food`
--

DROP TABLE IF EXISTS `indonesian_food`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `indonesian_food` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `indonesian_food`
--

LOCK TABLES `indonesian_food` WRITE;
/*!40000 ALTER TABLE `indonesian_food` DISABLE KEYS */;
INSERT INTO `indonesian_food` VALUES (1,'12','Sate Ayam / Kambing / Padang',NULL),(2,'12','Plecing Kangkung (water spinach salad)',NULL),(3,'12','Pepes Ikan',NULL),(4,'12','Ketoprak (peanut sauce salad)',NULL),(5,'12','Bebek Goreng (fried duck)',NULL),(6,'12','Pecel Lele (fried catfish)',NULL),(7,'12','Soto Betawi (Jakarta soup)',NULL),(8,'12','Sayur Asem (sour soup)',NULL),(9,'12','Sop Kaki Kambing (goat leg soup)',NULL),(10,'12','Nasi Goreng Babat',NULL),(11,'12','Nasi Uduk (coconut rice)',NULL),(12,'12','Bubur Ayam (chicken congee)',NULL),(13,'12','Woku (Manado soup curry)',NULL),(14,'12','Pempek',NULL),(15,'12','Gulai Kepala Ikan (fish head curry)',NULL),(16,'12','Rendang Jengkol',NULL),(17,'12','Rawon (beef stew)',NULL),(18,'12','Gulai Otak',NULL),(19,'12','Gudeg (stewed jackfruit)',NULL),(20,'12','Ayam Bakar Taliwang (grilled chicken)',NULL),(21,'12','Gado-gado (peanut sauce salad)',NULL),(22,'12','Mie Goreng Jawa ',NULL),(23,'12','Ayam Bakar Taliwang (grilled chicken)',NULL),(24,'12','Ikan Bakar ',NULL),(25,'12','Rica-rica (Manado dish)',NULL),(26,'12','Nasi Gule Solo (organ stew)',NULL),(27,'12','Bakso (Indonesian meatballs)',NULL),(28,'12','Sop Buntut (oxtail soup)',NULL),(29,'12','Ikan Goreng (deep fried fish)',NULL),(30,'12','Pelas',NULL),(31,'12','Ayam Bakar',NULL);
/*!40000 ALTER TABLE `indonesian_food` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `javanese_cuisine`
--

DROP TABLE IF EXISTS `javanese_cuisine`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `javanese_cuisine` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `javanese_cuisine`
--

LOCK TABLES `javanese_cuisine` WRITE;
/*!40000 ALTER TABLE `javanese_cuisine` DISABLE KEYS */;
INSERT INTO `javanese_cuisine` VALUES (1,'1','Gudeg Yogya','A traditional food from Yogyakarta and Central Java which is made from young nangka (jack fruit) boiled for several hours with palm sugar, spices, and coconut milk.'),(2,'1','Nasi ayam','A dish composed of rice, chicken, egg, tofu, and served with a sweet-salty coconut milk gravy.'),(3,'1','Tengkleng','Goat ribs and offal in a curry-like soup, similar to gule kambing, but with a lighter and thinner soup.'),(4,'1','Lotek','Almost identical to gado-gado, but sweeter. It is similar to pecel, but includes different vegetables as well as boiled egg slices and a garnish of fish or shrimp crackers and emping (Gnetum gnemon L. nut, flattened, dried, and fried into small thin crackers).'),(5,'1','Opor panggang','A  typical opor from Jepara. It is a kind of opor ayam but with distinctive flavor, since the chicken used in this dish is first roasted in a clay cauldron.'),(6,'1','Nasi Gandul','Beef served on white steamed rice poured with spicy savoury soup, served on banana leaf'),(7,'1','Sambal Goreng Krechek','Traditional spicy cattle skin dish made from seasoned krupuk kulit.'),(8,'1','Swikee Purwodadi','Frogs\' legs cooked in fermented soybean (tauco) soup.'),(9,'1','Tahu Campur','Beef and offal soup, mixed with fresh vegetables, potatoes, rice cake, and tofu. The secret ingredient is the caramelized fermented shrimp paste (petis) which is mixed in just before serving.'),(10,'1','Urap sayur','Vegetables in spiced grated coconut dressing.'),(11,'1','Sop Buntut','Oxtail soup.'),(12,'1','Buntil','A traditional Javanese dish of scraped coconut meat mixed with teri (anchovies) and spices, wrapped in a papaya leaf, then boiled in coconut milk.'),(13,'1','Sate','Skewered grilled meat is a common dish in Java. The Javanese variants are sate Tegal, sate Ambal, sate Solo, sate buntel, sate Madura, sate Ponorogo, etc.'),(14,'1','Bakso Malang','Bakso literally means meatball. Bakso Malang has more accompaniments, beside the meatball (mostly beef) itself. For example, offal, siomay dumplings (fried or steamed), tahu (tofu, fried or steamed, filled with meat), soun (mung bean threads), and yellow egg noodles. All of these are served in hot beef stock.'),(15,'1','Nasi Bogana Tegal','A steamed rice dish wrapped in banana leaves and served with a variety of side dishes.'),(16,'1','Sayur Mangut','A hot and spicy Ariid catfish head cooked in coconut milk.'),(17,'1','Tongseng cumi','Tongseng made of calamari or squid, instead of goat or chicken.'),(18,'1','Laksa Jepara','Made of chicken fillet, banana shrimp, chicken stock, coconut milk, lemongrass, kaffir lime leaves, salt, sugar, oil, and other ingredients.'),(19,'1','Soto Bangkong','A chicken soup in a small personal serving; mixed with rice, perkedel, and satay of cockles, chicken intestines, and quail eggs. Named after Bangkong crossroad in Semarang.'),(20,'1','Pecel ikan laut panggang','Roasted saltwater fish served with coconut milk sauce.'),(21,'1','Mie koclok','A noodle soup from Cirebon.'),(22,'1','Jepara shrimp soup','Similar to shrimp soup in general. This version of soup use shrimp broth and fried shrimp, also raw crushed chili. This soup is delicious eaten while still hot or warm.'),(23,'1','Bongko mento','Originated in Jepara palace, it is a snack wrapped in a banana leaf. Consists of omelet filled with sauteed shredded chicken breast mixed with oyster mushrooms, glass noodles, and coconut milk.'),(24,'1','Timlo Solo','A beef and vegetable soup. '),(25,'1','Botok',' traditional Javanese dish made from shredded coconut flesh which has been squeezed of its coconut milk, often mixed with other ingredients such as vegetables or fish, and wrapped in banana leaf and steamed.'),(26,'1','Sayur Lodeh','Assorted vegetables, stewed in coconut milk.'),(27,'1','Tahu tek-tek','A dish containing cut-up fried tofu, boiled vegetables (mostly beansprouts), potatoes, drenched in a peanut-based sauce. The sauce has caramelized fermented shrimp pasted (petis), chili, and garlic.'),(28,'1','Ayam penyet','Fried chicken (see ayam goreng), lightly smashed using a pestle in a mortar laced with sambal.'),(29,'1','Tengkleng','Goat ribs and offal in a curry-like soup, similar to gule kambing, but with a lighter and thinner soup.'),(30,'1','Nasi Gandul','Beef served on white steamed rice poured with spicy savoury soup, served on banana leaf.'),(31,'1','Sayur Mangut ','Hot and spicy Ariid catfish head cooked in coconut milk.');
/*!40000 ALTER TABLE `javanese_cuisine` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `overnight_oat`
--

DROP TABLE IF EXISTS `overnight_oat`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `overnight_oat` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Kategori` varchar(2) NOT NULL DEFAULT '2',
  `Menu` varchar(45) NOT NULL,
...
--
-- Dumping data for table `overnight_oat`
--

LOCK TABLES `overnight_oat` WRITE;
/*!40000 ALTER TABLE `overnight_oat` DISABLE KEYS */;
INSERT INTO `overnight_oat` VALUES (1,'2','Peanut Butter Overnight Oats','Oat dengan selai kacang dan coklat chips.'),(2,'2','Chocolate Chip Cookie','Oat dengan coklat chips, vanila yogurt dan cinnamon.'),(3,'2','Nutella','Oat dengan topping chocolate hazelnut nutella.'),(4,'2','Blueberry Overnight Oats','Oat dengan topping blueberries.'),(5,'2','Monkey Oats','Oat dengan topping mashed banana selai kacang dan coklat chips.'),(6,'2','Banana Bread','Oat dengan crushed walnuts or pecans.'),(7,'2','Cinnamon Apple','Oat dengan cinnamon or apple pie spice and raisins.'),(8,'2','Mint Chocolate Chip','Oat dengan pure peppermint extract dan coklat spirulina powder.'),(9,'2','High Protein Overnight Oats','Oat dengan favorite protein powder dan susu.'),(10,'2','Pumpkin Pie','Oat dengan pumpkin pie spice and pure vanilla extract'),(11,'2','Carrot Cake','Oat dengan shredded carrot, raisins and almond or coconut butter.'),(12,'2','Piña Colada','Plain coconut oatmeal'),(13,'2','Creamy Coffee','Oat dengan instant coffee dan nondairy creamer.'),(14,'2','Strawberry Shortcake','Oat dengan strawberry yogurt, and canned coconut milk or nondairy creamer.');
/*!40000 ALTER TABLE `overnight_oat` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-10-17 23:07:50
