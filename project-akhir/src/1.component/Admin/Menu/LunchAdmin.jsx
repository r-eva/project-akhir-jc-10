...
class MainCourseAdmin extends Component {
    ...
    renderMainCourse = () => {
        let showData = this.state.dataMainCourse.slice(this.state.page * this.state.pageContent, this.state.page * this.state.pageContent + this.state.pageContent)
    ...
    onBtnAdd = () => {
        ...
        Axios.post(urlApi + 'mainCourse', produkBaru)
        .then((res) => {
    ...
    onBtnSaveEdit = () => {
        ...
        Axios.put(urlApi + 'mainCourse/' + this.state.editItem.id, newItem)
        .then (res => {
            this.getMainCourseProduct()
    ...
    onBtnDelete = (object) => {
        Axios.delete(urlApi + 'mainCourse/' + object) 
        .then((res)=> {
            this.getMainCourseProduct()
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-12 text-center">
                                        ...
                                        {
                                            this.state.dataMainCourse.length - ((this.state.page + 1) * this.state.pageContent) <= 0
                                            ?
