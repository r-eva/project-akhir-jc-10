...
class BreakfastAdmin extends Component {
    ...
    componentDidMount () {
        this.getBreakfastProduct()
    }

    getBreakfastProduct = () => {
        Axios.get(urlApi + 'breakfast')
        .then(res => {
            this.setState({dataBreakfast: res.data})
        })
        .catch(err => {
            console.log(err)
        })
    ...
    renderBreakfast = () => {
        let showData = this.state.dataBreakfast.slice(this.state.page * this.state.pageContent, this.state.page * this.state.pageContent + this.state.pageContent)
    ...
    onBtnAdd = () => {
        ...
        Axios.post(urlApi + 'breakfast', produkBaru)
        .then((res) => {
    ...
    onBtnSaveEdit = () => {
        ...
        Axios.put(urlApi + 'breakfast/' + this.state.editItem.id, newItem)
        .then (res => {
            this.getBreakfastProduct()
    ...
    onBtnDelete = (object) => {
        Axios.delete(urlApi + 'breakfast/' + object) 
        .then((res)=> {
            this.getBreakfastProduct()
                            ...
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-12 text-center">
                                        ...
                                        {
                                            this.state.dataBreakfast.length - ((this.state.page + 1) * this.state.pageContent) <= 0
                                            ?
